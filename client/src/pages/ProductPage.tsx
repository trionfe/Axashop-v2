                    ...
                    return (
                      <button key={v.id} onClick={() => setSelectedVariantId(v.id)}
                        ...
                        <div className="aspect-[4/3] overflow-hidden relative">
                          <img src={SOCIAL_IMAGES[v.id] || v.image || group.image} alt={isSupabaseGroup ? v.nameKey : (t[v.nameKey] || v.nameKey)} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
