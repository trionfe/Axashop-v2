    ...
    <div className="w-full bg-[#030711] overflow-x-hidden relative">
      ...
      {showExchange && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4"
          ...
          <div className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-3xl border border-white/10 bg-[#0d0d14] shadow-2xl"
            onClick={e => e.stopPropagation()}>
            <div className="flex items-center justify-between p-6 border-b border-white/[0.06]">
              <div>
                <h2 className="text-xl font-black text-white">💸 Exchange AxAShop</h2>
                <p className="text-xs text-slate-500 font-mono mt-1">Convertissez entre méthodes de paiement</p>
              </div>
              <button onClick={() => setShowExchange(false)}
                className="w-9 h-9 rounded-xl bg-white/[0.05] text-slate-400 hover:text-white hover:bg-white/10 transition-all flex items-center justify-center text-lg">×</button>
            </div>
            <div className="p-6">
              <iframe
                src="/exchange.html"
            ...
            <div className="px-6 pb-6">
              <a href="https://discord.com/channels/1476550378987454534/1476973014460530718"
                target="_blank" rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full h-12 bg-[#5865F2] hover:bg-[#4752C4] text-white font-black rounded-2xl transition-all shadow-lg">
      ...
      {/* ── EXCHANGE FLOATING BUTTON ── */}
      <button
        onClick={() => setShowExchange(true)}
        className="fixed bottom-6 right-6 z-[150] flex items-center gap-2 px-5 h-12 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-white font-black rounded-2xl shadow-xl shadow-green-500/30 transition-all hover:scale-105 active:scale-95"
      >
